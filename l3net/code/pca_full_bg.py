...
Y = np.load('../data/y_background_fold1_train.npy')
...
print(basis.shape)
np.save("../basis/basis_full_fold1_bg.npy", basis)

X = np.load('../data/x_background_fold2_train.npy')
Y = np.load('../data/y_background_fold2_train.npy')
...
basis = np.asarray(basis)
print(basis.shape)
np.save("../basis/basis_full_fold2_bg.npy", basis)

X = np.load('../data/x_background_fold3_train.npy')
Y = np.load('../data/y_background_fold3_train.npy')
...
basis = np.asarray(basis)
print(basis.shape)
np.save("../basis/basis_full_fold3_bg.npy", basis)

X = np.load('../data/x_background_fold4_train.npy')
Y = np.load('../data/y_background_fold4_train.npy')
...
basis = np.asarray(basis)
print(basis.shape)
np.save("../basis/basis_full_fold4_bg.npy", basis)
