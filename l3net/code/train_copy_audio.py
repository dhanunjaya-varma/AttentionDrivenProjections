...
np.save('../data/x_audio_fold1_train.npy', np.array(data))
np.save('../data/y_audio_fold1_train.npy', np.array(label))
...
print(np.array(data).shape)
print(np.array(label).shape)
np.save('../data/x_audio_fold2_train.npy', np.array(data))
np.save('../data/y_audio_fold2_train.npy', np.array(label))
...
print(np.array(data).shape)
print(np.array(label).shape)
np.save('../data/x_audio_fold3_train.npy', np.array(data))
np.save('../data/y_audio_fold3_train.npy', np.array(label))
...
print(np.array(data).shape)
print(np.array(label).shape)
np.save('../data/x_audio_fold4_train.npy', np.array(data))
np.save('../data/y_audio_fold4_train.npy', np.array(label))
