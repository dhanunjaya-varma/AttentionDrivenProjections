...
np.save('../data/x_background_fold1_train.npy', np.array(data))
np.save('../data/y_background_fold1_train.npy', np.array(label))
...
print(np.array(data).shape)
print(np.array(label).shape)
np.save('../data/x_background_fold2_train.npy', np.array(data))
np.save('../data/y_background_fold2_train.npy', np.array(label))
...
print(np.array(data).shape)
print(np.array(label).shape)
np.save('../data/x_background_fold3_train.npy', np.array(data))
np.save('../data/y_background_fold3_train.npy', np.array(label))
...
print(np.array(data).shape)
print(np.array(label).shape)
np.save('../data/x_background_fold4_train.npy', np.array(data))
np.save('../data/y_background_fold4_train.npy', np.array(label))
