...
np.save('../data/x_foreground_fold1_test.npy', np.array(data))
np.save('../data/y_foreground_fold1_test.npy', np.array(label))
...
print(np.array(data).shape)
print(np.array(label).shape)
np.save('../data/x_foreground_fold2_test.npy', np.array(data))
np.save('../data/y_foreground_fold2_test.npy', np.array(label))
...
print(np.array(data).shape)
print(np.array(label).shape)
np.save('../data/x_foreground_fold3_test.npy', np.array(data))
np.save('../data/y_foreground_fold3_test.npy', np.array(label))
...
print(np.array(data).shape)
print(np.array(label).shape)
np.save('../data/x_foreground_fold4_test.npy', np.array(data))
np.save('../data/y_foreground_fold4_test.npy', np.array(label))
