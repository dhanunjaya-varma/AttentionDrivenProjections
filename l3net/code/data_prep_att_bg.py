...
basis = np.load('../basis/basis_full_fold1_bg.npy')
...
np.save('../data/x_train_auto_fold1_bg.npy', x_train_new)
np.save('../data/x_test_auto_fold1_bg.npy', x_test_new)
...
basis = np.load('../basis/basis_full_fold2_bg.npy')
m = np.mean(x_train,axis=0)
x_train = x_train - m
x_test = x_test - m
...
np.save('../data/x_train_auto_fold2_bg.npy', x_train_new)
np.save('../data/x_test_auto_fold2_bg.npy', x_test_new)
...
basis = np.load('../basis/basis_full_fold3_bg.npy')
m = np.mean(x_train,axis=0)
x_train = x_train - m
x_test = x_test - m
...
np.save('../data/x_train_auto_fold3_bg.npy', x_train_new)
np.save('../data/x_test_auto_fold3_bg.npy', x_test_new)
...
basis = np.load('../basis/basis_full_fold4_bg.npy')
m = np.mean(x_train,axis=0)
x_train = x_train - m
x_test = x_test - m
...
np.save('../data/x_train_auto_fold4_bg.npy', x_train_new)
np.save('../data/x_test_auto_fold4_bg.npy', x_test_new)